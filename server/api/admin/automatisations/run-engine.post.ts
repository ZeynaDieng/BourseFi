...
export default defineEventHandler(async (event) => {
  ...
  for (const cand of candidates) {
    ...
    // 1. Dédoublonnage strict par email
    ...
    // 3. Ne pas relancer si déjà finalisé
    ...
    // 4. Sélection intelligente du scénario
    ...
    const appUrl = (config.public as { appUrl?: string })?.appUrl || 'https://boursefi.sn'
