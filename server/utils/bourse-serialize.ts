...
export function serializeBourse(b: BourseRow) {
  ...
  return {
    ...
    hasTuitionFee: economy.hasTuitionFee && !(currentTarif && currentTarif.montantBourse && currentTarif.montant === currentTarif.montantBourse),
    tuitionFee: (currentTarif && currentTarif.montantBourse && currentTarif.montant === currentTarif.montantBourse) ? null : (currentTarif?.montant ?? economy.tuitionFee),
    ...
    economie: (currentTarif && currentTarif.montantBourse && currentTarif.montant === currentTarif.montantBourse) ? null : economy.economie,
    economiePercent: (currentTarif && currentTarif.montantBourse && currentTarif.montant === currentTarif.montantBourse) ? null : economy.economiePercent,
    ...
    fraisInscription: currentTarif?.fraisInscription ?? null,
    mensualite: currentTarif?.mensualite ?? null,
    nombreMois: currentTarif?.nombreMois ?? 10,
    autresFrais: currentTarif?.autresFrais ?? null,
    fraisUniforme: currentTarif?.fraisUniforme ?? null,
    fraisSoutenance: currentTarif?.fraisSoutenance ?? null,
