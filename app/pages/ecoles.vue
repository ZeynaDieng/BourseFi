...
<template>
  <main class="mx-auto max-w-7xl px-6 py-12 md:px-8">
    <header class="mb-12 text-center md:text-left">
      ...
      <h1 class="mt-3 font-headline text-4xl font-extrabold text-primary">Ecoles et instituts financeurs</h1>
      <p class="mx-auto mt-4 max-w-2xl text-slate-600 md:mx-0">
        Choisissez une ecole pour voir les formations couvertes par nos partenaires (mairies, agences…) et deposer votre
        dossier depuis la fiche formation.
      </p>
    </header>
