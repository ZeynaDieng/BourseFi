  ...
  <div class="min-h-screen bg-slate-50">
    <div class="max-w-4xl mx-auto px-4 py-12">
      <div class="bg-white rounded-2xl shadow-sm p-8 md:p-12">
        <h1 class="text-3xl font-bold text-primary mb-6">Mentions Légales</h1>
        <p class="text-slate-600 mb-8">Dernière mise à jour : 13 juillet 2026</p>

        <div class="prose prose-slate max-w-none space-y-6">
          <section>
            <h2 class="text-xl font-semibold text-slate-900 mb-3">Éditeur de la plateforme</h2>
            <p class="text-slate-600 mb-4">
              La plateforme <strong>BourseFi</strong> est éditée et exploitée par
              l'entreprise <strong>MATKAM</strong>.
            </p>
            <div class="rounded-xl border border-slate-200 bg-slate-50 p-5 space-y-2 text-slate-700">
              ...
              <p><strong>NINEA :</strong> 013125324</p>
            </div>
          </section>
        </div>
      </div>
